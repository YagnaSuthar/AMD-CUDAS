...
def build_evaluator_prompt(
    ...
    return (
        ...
        "2. concept_depth → depth of understanding (the 'why')\n"
        "3. communication → clarity and logical structure\n"
        "4. confidence → decisiveness and avoidance of filler\n\n"
        "---\n\n"
        ...
        "* If correctness ≤ 3: concept_depth MUST be capped at 5.\n"
        "* If answer is incomplete: correctness MUST be capped at 5.\n"
        "* If NO ANSWER / Refusal: correctness = 0, concept_depth = 0, confidence = 1.\n\n"
        "---\n\n"
