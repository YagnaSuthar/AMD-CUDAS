...
const CcIcon    = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="2" ry="2" /><path d="M10 10a2 2 0 0 0-4 0v4a2 2 0 0 0 4 0" /><path d="M18 10a2 2 0 0 0-4 0v4a2 2 0 0 0 4 0" /></svg>;
    ...
    <div className="meet-root">
      ...
      <div className="meet-controls">
        ...
        {isActive && state !== STATES.EVALUATING && (
          ...
          {isActive && state !== STATES.EVALUATING && (
            <button
              className={`meet-ctrl-btn transcript-toggle ${showTranscript ? 'active' : 'default'}`}
              onClick={() => setShowTranscript(prev => !prev)}
              title="Toggle Transcript (CC)"
            >
              <CcIcon />
            </button>
          )}
